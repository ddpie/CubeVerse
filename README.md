...
- **CLI 工具**：使用 Kiro or Kiro CLI（原 Amazon Q Developer CLI）进行命令行开发
...
对于使用 AI 辅助工具开发复杂游戏项目，我们推荐以下结构化流程：

1. **粗略构思** - 确定游戏的基本概念和核心玩法（人来提供文档）
2. **代码研究** - 了解相关技术和现有解决方案（AI 来做，人来监控）
3. **需求明确** - 通过 AI 提问来细化和明确需求（AI 提问，人回答）
4. **详细设计** - 设计系统架构、组件交互和数据流（AI 来做，人来监控）
5. **开发计划** - 制定任务清单和开发路线图（AI 来做，人来监控）
6. **逐步实现** - 通过自然语言指令实现功能（AI 来做，人来监控）

这一流程特别适合团队协作和复杂功能开发。通过 Kiro 等 AI 工具的协同，即使是非技术团队成员也能参与整个开发过程，从创意构思到最终实现。
